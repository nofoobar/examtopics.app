...
VENDORS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Network security certifications for firewalls, cloud security and SOC operations.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  True,
    },
    {
        "name":        "Fortinet",
        "slug":        "fortinet",
        "description": "Network security certifications including NSE 1 through NSE 8.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  True,
    },
    ...
    },
    {
        "name":        "CSA",
        "slug":        "csa",
        "description": "Cloud Security Alliance certifications including CCSK and CCZT.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    {
        "name":        "ACAMS",
        "slug":        "acams",
        "description": "Association of Certified Anti-Money Laundering Specialists certifications including CAMS.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  True,
    },
    ...
    },
    {
        "name":        "ITIL",
        "slug":        "itil",
        "description": "ITIL certifications for IT service management best practices.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  True,
    },
    {
        "name":        "Prince2",
        "slug":        "prince2",
        "description": "PRINCE2 project management certifications for structured project delivery.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    ...
    # -- Data & AI -----------------------------------------------------------
    {
        ...
        "description": "Python programming certifications including PCEP, PCAP and PCPP.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  True,
    },
    {
        "name":        "Tableau",
        "slug":        "tableau",
        "description": "Data visualisation certifications including Tableau Desktop Specialist and Certified Associate.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    {
        "name":        "Splunk",
        "slug":        "splunk",
        "description": "Splunk certifications including Splunk Core Certified User and Certified Admin.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    {
        "name":        "NVIDIA",
        "slug":        "nvidia",
        "description": "AI and data engineering certifications for NVIDIA GPUs and accelerated computing.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    ...
    },
    {
        "name":        "ServiceNow",
        "slug":        "servicenow",
        "description": "ServiceNow certifications including Certified System Administrator and Application Developer.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    {
        "name":        "UIPath",
        "slug":        "uipath",
        "description": "RPA certifications including UiPath Certified Professional RPA Developer.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
    # -- Catch-all -----------------------------------------------------------
    {
        "name":        "Others",
        "slug":        "others",
        "description": "Certifications from other vendors and organisations not listed above.",
        "logo_url":    None,
        "is_active":   True,
        "is_popular":  False,
    },
